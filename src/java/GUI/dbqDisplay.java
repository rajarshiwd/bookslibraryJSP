...
/**author rajarshi 
 */
public class dbqDisplay extends SimpleTagSupport {
    Connection con=null;
    ResultSet rs=null;
    ...
    public void doTag() throws JspException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(dbqDisplay.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            throw new JspException("Error in dbqDisplay tag", ex);
        }
    }
}
